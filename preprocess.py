...
if os.path.isfile('nsmc.h5'):
    ...
    train_dataset = pd.read_csv('data/ratings_train.txt', sep='\t').dropna(axis=0)  # Remove NaN
    test_dataset = pd.read_csv('data/ratings_test.txt', sep='\t').dropna(axis=0)  # Remove NaN
    ...
    nsmc = h5py.File('data/nsmc.h5', 'w', rdcc_nslots=11213, rdcc_nbytes=1024**3, rdcc_w0=1)
